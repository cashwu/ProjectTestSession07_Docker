...
namespace Sample.RepositoryTests.Misc
{
    ...
    {
        private readonly string _testConnectionString = string.Concat(
            TestDbConnection.LocalDb.Master,
        ...
        public void CreateDatabase()
        {
            ...
            using (var connection = new SqlConnection(TestDbConnection.LocalDb.Master))
            {
